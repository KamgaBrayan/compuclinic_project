...
class Dons extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      typeDonnee: 'entree',
      donnee:[['semaine 1',[30,153,906,14250]],['semaine 2',[18,103,706,12250]],['semaine 3',[4,10,131,1250]],['semaine 4',[8,40,75,1750]]],  
...
export default connect(mapStateToProps, {})(Dons);
