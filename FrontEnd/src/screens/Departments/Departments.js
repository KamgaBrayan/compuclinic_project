...
import PlateauTechniqueImg2 from "../../assets/images/comptabilite/cimpha2.jpg"; 
        ...
        <div>
          <div className="container-fluid">
            ...
            <div className="row clearfix">
              ...
              <Department title="Comptabilite" role="Comptable" image={PlateauTechniqueImg2} link='/comptabilite' />
            </div>
            {/*<div className="row clearfix">
              <AdvancedValidation />
            </div>*/}
