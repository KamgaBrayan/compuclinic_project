...
export const wServer = {
    ...
    GET : {
        ...
        LABORANTIN: {
            TYPES_EXAMENS: `${wServerRoot}/laborantin/types-examens`,
            TYPE_EXAMEN_BY_ID: (id) => `${wServerRoot}/laborantin/types-examens/${id}`,
            TYPES_EXAMENS_PARAMETRES: (typeExamenId) => `${wServerRoot}/laborantin/types-examens/${typeExamenId}/parametres`,
            PRESCRIPTIONS_EN_ATTENTE: `${wServerRoot}/laborantin/prescriptions`,
            ...
            PHARMACIE: {
                ALL_DRUGS: `${wServerRoot}/laborantin/pharmacie/drugs`,
                SEARCH_DRUGS: `${wServerRoot}/laborantin/pharmacie/drugs/search`,
                DRUG_BY_ID: (id) => `${wServerRoot}/laborantin/pharmacie/drugs/${id}`,
                DRUG_DOSAGES: (drugId) => `${wServerRoot}/laborantin/pharmacie/drugs/${drugId}/dosage`,
                LOW_STOCK: `${wServerRoot}/laborantin/pharmacie/drugs/low-stock`,
                STATISTICS: `${wServerRoot}/laborantin/pharmacie/statistics`,
            }
        }
    },
